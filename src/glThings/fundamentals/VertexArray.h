...
namespace m4w {
    ...
    public:
        ...
        static m4w::Pointer<VertexArray> Sphere(unsigned int sub_divisions, float radius, float color[4], bool smooth = true);
        static m4w::Pointer<VertexArray> Sphere(unsigned int sub_divisions, float radius, float r, float g, float b, float a, bool smooth = true);
