...
Camera::Camera(unsigned int width, unsigned int height, Projection* projection, View* view)
    : m_Projection(projection), m_View(view), m_FrameBuffer(new FrameBuffer(width, height))
{ }
