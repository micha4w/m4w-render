...
int main() {
    ...
    m4w::Pointer<m4w::Window> window = new m4w::Window(3440, 1440, "Geem");
...
//    window->GetFrameBuffer()->SetClearColor(0, 0.043, 0.804);
    ...
    sphere_mesh.SetVertexArray( m4w::VertexArray::Sphere(1, 5.f, 0.f, 0.f, 3.f, 0.8f, 0.2f, 0.4f, 1.f, false) );
